        ...
        <div className="flex flex-col about-us-container">
            ...
            <section className="bg-white w-full h-[750px] flex items-center justify-center relative">
                <div className="text-center basis-[57%] transform -translate-y-1/4">
                    <h2 className=" text-black tracking-[0.25em] text-4xl mb-8">FUSION PILLARS</h2>
            ...
            <section className="bg-white w-full h-[1200px] flex flex-col items-center">
                ...
                <div className="flex justify-center gap-16">
                    <div className="flex flex-col items-center text-center">
                        <div className="bg-gray-300 w-64 h-64 mb-6"></div>
             ...
             {/* 
            <section className="bg-white w-full flex flex-col items-center py-16">
                <div className="text-center max-w-2/3">
                    <h2 className="text-black text-4xl tracking-wide mb-12">ALYANSA</h2>
                    <div className="flex justify-center gap-16">
                        {['PASS', 'KABA', 'PUSO'].map((item) => (
                            <div key={item} className="flex flex-col items-center text-center">
                                <div className="bg-gray-300 w-64 h-64 mb-6"></div>
                                <h3 className="text-xl font-bold mb-4">{item}</h3>
                                <p className="text-black mb-6">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                                <button className="bg-[#fee270] text-black py-2 px-4 border border-black">BUTTON</button>
                            </div>
                        ))}
                    </div>
                </div>
            ...
            */}
            ...
            <footer className="bg-[#fee270] w-full h-64">
